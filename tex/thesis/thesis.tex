 ...
 resource reservation provided by most common OS induced further research in field of resource reservation and isolation. 
  ...
  \label{chap:bck}
    ...
    \label{sec:ctx:virt}
      ...
      % TODO napisac, ze to dosc stara idea + troche historii
      % TODO zmienic na ogolnie uznane zrodlo, nie WIKI!
    ...
    \label{sec:impl:env}
	  ...
	  \section{CM4J}
		\label{sec:impl:module}
			...
			To provide fully functional system allowing all expected functionalities (described in requirement analysis section)
      ...
      \label{sec:impl:persist}
        ...
        With regard to statistics flow statistics are gathered and managed by operating system whereas \gls{acr:vnic}'s
        traffic load is gathered starting from \gls{acr:jims} restart.
