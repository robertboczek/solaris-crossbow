...
\begin{document}
  ...
  \chapter{Solaris OS as a resource virtualization environment}
    ...
    \section{Lightweight OS-level virtualization with Solaris Containers}  % czy to na pewno w porzadku?
  ...
  \chapter{Implementation}
    ...
    \section{Model transformation details}


    \section{Low-level Crossbow functions access}
  ...
  \chapter{Case Study}
    ...
    \section{Clustered GlassFish}
      ...
      \subsection{Integration with GlassFish load balancer}  % ???
