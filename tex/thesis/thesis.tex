...
\begin{document}
  ...
  \label{chap:req}
   ...
   broadcast domain preservation (\ref{sec:req:broadcast}) are discussed in the remaining part of this chapter.
	...
	to fulfill. Section \ref{sec:req:env} on the other hand presented expectations towards underlying environment. In order to
	meet all above constraints system had to be implemented on OS supporting network and resource virtualization, with ability to
