...
\begin{document}
  ...
  \chapter{Requirements analysis}
    ...
    \section*{Chapter overview}
		...
		virtual network elements and demanded resources recovered from selected ( previously
		prepared ) repository and fully monitored network traffic. This target implicated necessity of creating functional 
  ...
  \chapter{Implementation}
    ...
    \section{Domain model transformation details}
		...
		interfaces or exist as detached crossbow flows. Four types of flows have been created: AnyFilter, PortFilter, 
                TransportFilter, IpFilter. Distinction between filters have been to allow easier network traffic classification. 
