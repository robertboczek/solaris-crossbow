...
\begin{document}
  ...
  \label{chap:impl}
	...
	\label{sec:impl:module}
      ...
      \label{sec:impl:comp}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=.8\textheight, angle=90]{img/impl/link.pdf}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=.8\textheight, angle=90]{img/impl/flow.pdf}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[text height=1.5ex, text depth=.25ex]
            ...
            \begin{umlseqdiag}
              ...
              \umlobject{GUI}
              \umlobject[x=2]{ProgressShell}
              \umlobject[x=5]{Supervisor}
              \umlobject[x=9]{GraphToModelTranslator}
              \umlobject[x=13]{CrossbowNotification}
      ...
      \label{sub:uc:limit}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[node distance=0]
            ...
            \node [right=of img.north east] {bandwidth $[\mathrm{B}/\mathrm{s}]$};
          \end{tikzpicture}
  ...
  \label{chap:sum}
	...
	Research in the area of networking virtualization approaches together with implemented \gls{acr:cm4j} system resulted
	in achieving  really worth to be mentioned objectives:
    ...
    \section{Further work}
      ...
      did not allow for as deep an insight at all issues as was initially planned. Since \gls{acr:cm4j} is an open source project
      editing and adding additional functionalities would be desirable.
  ...
  % TODO przejrzec bibliografie (literowki itd)
