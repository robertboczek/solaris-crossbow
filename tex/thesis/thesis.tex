  ...
  \chapter{Solaris OS as a resource virtualization environment}
    ...
    \label{sec:sol:containers}
      ...
      \label{sub:}
        ...
        makes it possible to define resource controls (rctls) at various level, also on per-zone basis. CPU shares,
        ...
        system is running, without interrupting the container normal operation. This can be of extreme importance as far
        ...
        \begin{figure}[H]
          \begin{center}
            \begin{tikzpicture}[node distance=5mm,]
              ...
              { [start chain, every node/.style={terminal, on chain, join, text width=3cm, align=center}, every join/.style={->}]
              ...
              \begin{pgfonlayer}{background}
                \node [terminal] (background) [fit=(prep) (post), align=center, style=terminal] {};
              \end{pgfonlayer}
    ...
    \label{sec:sol:xbow}
      ...
      \subsection{Crossbow architecture}
        ...
        % TODO ,,more about them later'' <- nie moze tego byc
        
        Traffic separation is achieved with fundamental blocks of new architecture which are Virtual NICs (VNICs) created
        by partitioning physical NIC. A VNIC can be created over NIC or Etherstub ( more about them later ) and be
        ...
        be dropped as it is wiser to dop them then to expend OS CPU resources.
    ...
    \label{sec:sol:res}
      ...
      with respect to different workloads. These management allows you to:
