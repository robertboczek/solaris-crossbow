  ...
  \chapter{Case Study}
    ...
    \section{Multimedia server}
      ...
      \subsection{Scenario description}
		...
		Network traffic in this case was differentiated among users through priorities and maximum bandwidth filters created over the flow paths. 
		The figure below presents precisely network structure and client configuration.
		...
		The section \textbf{'Preparation of the environment'} describes an example of how a new zone and then snapshot may be created, 
                which then would be used as virtual appliance.
