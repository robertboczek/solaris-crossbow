...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    manner of creating any requested, virtualized network structure with virtualized resources, network elements and
    ...
    contained in the Crossbow module, Solaris OS seemed to be suitable environment to proceed further research.
