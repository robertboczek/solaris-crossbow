...
\begin{document}
  ...
  \thispagestyle{empty}
    ...
    \textit{We wish to acknowledge the support and assistance given us by \\ professor~Krzysztof~Zieliński and
            Marcin~Jarząb. \\ Their generously contributed ideas, feedback and advice were of great help to us. \\
  ...
  \label{chap:impl}
    ...
    \label{sec:impl:jims}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[width=.9\textwidth]{img/impl/jims_and_cm4j.png}
    ...
    \label{sec:impl:summary}
      ...
      These technologies also helped to fulfill defined non-functional requirements (evolvability, extensibility,
      composability, etc.).
