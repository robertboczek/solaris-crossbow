...
\begin{document}
  ...
  \chapter{Implementation}
	...
	Section \ref{sec:impl:env} informs about implementational environment apects like requested operating system, libraries presence or
  ...
  \chapter{Case Study}
    ...
    \label{sec:uc:prep}
      ...
      \label{sub:uc:xbow}
        ...
        \begin{lstlisting}[caption={Etherstubs}]
          # dladm show-etherstub | egrep ``^uc_''
        \end{lstlisting}

        \begin{lstlisting}[caption={Virtual interfaces and flows created on top of them}]
          # dladm show-vnic | egrep ``^uc_''

          # flowadm show-flow | egrep ``^uc_''
        \end{lstlisting}
    ...
    \label{sec:uc:enhance}
      ...
      % * effects available instantaneously (automatic management/adjustment)
      % * virtual --- flexible
