...
\begin{document}
  ...
  \chapter{Context}  % TODO ładniej
    ...
    Currently there are three existing models performing \gls{acr:qos} in the IP network:
    ...
    \section{QoS-aware networking}
      ...
      \gls{acr:qos} (Quality of Service) is an issue in all types of networks such as IP, Token Ring, Frame Relay or even ATM.
      ...
      sender and receiver and sets \gls{acr:qos} parameters. Despite the fact that all approaches are very interesting and
      meaningful this paper focuses mainly on the IP network and its approach to \gls{acr:qos}.
    ...
    \section{Multilevel network virtualization}
      ...
      should be considered --- virtualization at the Data Link Layer of the OSI/ISO model, providing software
      ...
      \subsection{Types of virtual networks}
        ...
        External virtualization is implemented with Layer 2 switches aware of \gls{acr:vlan} technology. With these devices,
        entire network is split into fully-isolated parts, each becoming a new independent network. Routers can then be
        used to establish connectivity between selected subnetworks.

        The approaches listed can be interoperate to create hybrid topologies with some parts of a network using
        internal virtualization and some using external one. The approaches to network virtualization are depicted in
        figure \ref{fig:ctx:nvtypes}

        % TODO v obrazek z porownaniem
      ...
      \subsection{Virtualized network devices}
        ...
        Two approaches can be distinguished: physical devices are partitioned to create logical entities with assigned
        resources or software-based solutions are used to create independent virtualized components with the same
        behaviour as their physical counterparts. Virtualization here means both creating virtual as well as logical
        resources. Both methods can be applied at various layers of the OSI/ISO model.
        ...
        Logical devices require specialized hardware and the approach is used mainly in high-end solutions. \gls{acr:vlan}
        technology is one of the most widely used partitioning techniques within Data Link layer --- ports of a switch
        are grouped to provide separate broadcast domains. Another technique, used to merge geographically distributed
        segments and create single Layer 2 segment is VPLS () \cite{moreno}.
        ...
        logical
        - physical resource partitioning and assignment
        - Layer2: partitionable NICs, VLAN, VPLS
        - Layer3: VRF
      ...
      \subsection{,,Network in a box'' concept}
        ...
        % zbiera do kupy: internal virtualization, virtual devices, qos control, virtual appliances
