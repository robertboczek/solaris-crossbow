    ...
    \label{sec:ctx:infra}
      ...
      \subsection{Simulations and testing}
        ...
        specific state when needed.
          ...
          % create the whole environment easily
          % change as needed to adjust the parameters
          % use to do prototyping
          % use as a model for actual installation
          % cheaper - software implementation
          % network protocol testing
        
          % testing environment supporting development teams
          % create environment reflecting the real deployment conditions
        % adjustable, can be duplicated and restored easily
