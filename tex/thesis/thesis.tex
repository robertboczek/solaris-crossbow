...
\begin{document}
  ...
  \label{chap:cs}
    ...
    \label{sec:uc:eval}
      ...
      % TODO  opisac
      %
      % * created infrastructure fulfilled the requirements of isolation and QoS policies
      % * resources instrumented and exposed as MBeans
      % * the topology can be discovered and gathered statistics analyzed
