  ...
  \chapter{Context}  % TODO ładniej
    ...
    \section{Multilevel network virtualization}
      ...
      \subsection{Types of virtual networks}
        ...
        Virtualized networks belong to one of two main classes --- internal or external. Internal virtualization
        utilizes a single machine to create a logical network topology inside, whereas external virtualization means
        using existing physical infrastructure (comprising multiple nodes) to build subnetworks on top of it.

        As far as internal virtualization is considered, the main building blocks are virtual network interface cards
        and virtual switches. These components build logical links between virtual appliances (counterparts of physical
        machines). Examples of internal virtualization solutions include Xen domains (TODO sprawdzic), VirtualBox
        internal networks and Solaris Containers with Crossbow technology.
        ...
        % TODO ref do System Administration Guide: Network Interfaces and Network Virtualization
