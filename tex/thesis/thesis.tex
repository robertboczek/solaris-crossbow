          ...
          \begin{figure}[H]
            ...
            \begin{tikzpicture}[text height=1.5ex, text depth=.25ex]
              ...
              \begin{umlseqdiag}
                ...
                \umlobject[class=Client]{Client}
                \umlobject[class=Manager]{Manager}
                \umlobject[class=Native library]{Native library}
                \umlobject[class=Publisher]{Publisher}
          ...
          \begin{figure}[H]
            ...
            \begin{tikzpicture}[text height=1.5ex, text depth=.25ex]
              ...
              \begin{umlseqdiag}
                ...
                \umlobject[class=GUI]{GUI}
                \umlobject[class=Supervisor]{Supervisor}
                \umlobject[class=Worker, x=10]{Worker}
                \umlobject[class= VA Repository, x=14]{VA Repository}
          ...
          \begin{figure}[H]
            ...
            \begin{tikzpicture}[text height=1.5ex, text depth=.25ex]
              ...
              \begin{umlseqdiag}
                ...
                \umlobject[class=GUI]{GUI}
                \umlobject[class=StatisticsGatherer]{StatisticsGatherer}
                \umlobject[class=Entity object]{Entity object}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[text height=1.5ex, text depth=.25ex]
            ...
            \begin{umlseqdiag}
              ...
              \umlobject[class=GUI]{GUI}
              \umlobject[class=Supervisor]{Supervisor}
              \umlobject[class=ProgressShell]{ProgressShell}
              \umlobject[class=CrossbowNotification]{CrossbowNotification}
