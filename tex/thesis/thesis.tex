...
\begin{document}
  ...
  \chapter{Introduction}
   ...
   \section{Thesis statement}
	...
	\emph{ System with layered architecture, that would facilitate working with fully isolated virtualized network and resources
	 grouped by project name, could be created. }
