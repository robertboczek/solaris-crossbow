...
\begin{document}
  ...
  \chapter{The system architecture}
    ...
    \section{Architecture overview}
      ...
      \begin{figure}[H]
        \begin{center}
          \begin{tikzpicture}[start chain,
            ...
            \node (inst) [below=of infr] {Resource instrumentation layer};
      ...
      % TODO deployment / srodowisko dzialania
    ...
    \section{Crossbow resources instrumentation}
      ...
      resources of the underlying operating system. This abstract layer can be further leveraged to build more
      sophisticated systems on top of it.
      
      % Also, there is an abstract mechanism provided that allows to embed
      % entities that represent the resources in third-party containers (e.g. JMX servers).
      ...
      \subsection{Separation of concerns}
        ...
        \subsubsection{Entity objects}
          ...
          properties can be accessed and manipulated.
        ...
        \subsubsection{Manager objects}
          ...
          system and provide ways to access them (as entity objects). The resources can also be published in external repositories.

          % TODO tutaj seq. diagram?
          % TODO _publisher_ w managerach
      ...
      \subsection{Manageable Solaris OS resources}

        % TODO tutaj lista/schemat wszystkiego, czym mozemy zarzadzac przez mbeany
