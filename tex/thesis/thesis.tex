...
\begin{document}
  ...
  \label{chap:req}
    ...
    % TODO  ___definicja___ glownych procesow! instancjonowanie, discovery, monitoring --- co to robi, na wysokim
    % poziomie abstrakcji, bez szczegolow
  ...
  \label{chap:impl}
    ...
    \label{sec:impl:env}
      ...
      \gls{acr:jims} architecture is generally based on \gls{acr:jmx} --- technology for distributed resource
