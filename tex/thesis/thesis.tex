...
\begin{document}
  ...
  \chapter{The system architecture}
    ...
    \label{sec:arch:inst}
      ...
      \subsection{Instrumented Solaris OS resources}
        ...
        \begin{figure}[H]
          \begin{center}
            \begin{tikzpicture}[every node/.style={minimum width=2.5cm},
                                text height=1.5ex, text depth=.25ex]
              ...
              \node (eether) [terminal, minimum width=3.5cm, right=of eflow] {EtherstubMBean};
              \node (mether) [terminal, minimum width=3.5cm, below=of eether] {EtherstubManager}
                edge [->] node [auto] {} (eether);

              \node (enic) [terminal, right=of eether] {NICMBean};
  ...
  \chapter{Implementation}
    ...
    \section*{Chapter overview}
      ...
      Section \ref{sec:impl:persist} describes adopted approach to data persistance.
  ...
  \chapter{Summary}
    ...
    \section{Conclusions}
		...
		Deep investigation during work on this paper allowed better understanding of concepts like network virtualization,
    ...
    \section{Achieved goals}
		...
		would encourage reader to further issue investigation.
