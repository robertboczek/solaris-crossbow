  ...
  \label{chap:impl}
    ...
    \section{Virtual infrastructure management}
      ...
      \subsection{Integration with JIMS}
        ...
        \todo{wiecej o dynamicznym ladowaniu modulow z repo}
      ...
      \label{ssec:impl:gui}
        ...
        Figure \ref{fig:impl:guiseq} presents interaction between \gls{acr:gui} and other components of th system while
        performing the instantiation operation.
