  ...
  \chapter{Solaris OS as a resource virtualization environment}
    ...
    \label{sec:sol:containers}
      ...
      \label{sub:}
        ...
        process levels \cite{sag}. The resource control process is dynamic - assignments can be changes as the system
    ...
    \label{sec:sol:xbow}
      ...
      \subsection{Running examples of flowadm and dladm command}
        ...
        More information about \textbf{man flowadm} and \textbf{man dladm} can be found in manual.
