...
\begin{document}
  ...
  \chapter{Solaris OS as a resource virtualization environment}
    ...
    \section{General information}
      ...
      % TODO intro with history (when started and so on, minimum sentences on that!)
    ...
    \section{Lightweight OS-level virtualization with Solaris Containers}
      ...
      \label{sub:}
        ...
        quota. Also, network isolation is supported at two levels: basic, at the IP layer, and advanced fine-grained
        network isolation and virtualization with Crossbow technology. (TODO verify the sentence!)

        Each zone can run a different set of applications, with optional system call translation
      ...
      \label{sub:}
        ...
        A model was created to describe the states a zone can be in. A non-global zone can be in one of six states:
      ...
      \label{sub:}
        ...
        and no interprocess communication can take place, except for network-based one.
        ...
        \begin{figure}[H]
          \begin{center}
            \begin{tikzpicture}[start chain, node distance=5mm,
                                every node/.style={terminal, on chain, join, text width=3.5cm, align=center},
                                every join/.style={->}]
