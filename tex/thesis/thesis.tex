...
\begin{document}
  ...
  \label{chap:sum}
    ...
    \section{Conclusions}
		...
		to distinguish certain group of independent, loosely coupled components. Together these components provided planned
    ...
    \section{Achieved goals}
		...
		\begin{itemize}
			...
			\item Reusability provided thanks to loosely coupled components hidden under well definied interfaces,
